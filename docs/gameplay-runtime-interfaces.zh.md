...
更新：2026-09-12。本文替代早期关于 pressureScore、冲刺档位和心率强耦合的接口讨论，保留现行接入责任。数值规则见 [游戏数值与手感配置](游戏数值与手感配置.zh.md)，网络时序与实际设备问题见 [联机架构第 8 节](平台能力/realtime-multiplayer-notes.zh.md)。
