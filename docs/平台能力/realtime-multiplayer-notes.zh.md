...
- **2026-09-18 玩法版本 68（当前）**：炮火外围击退椭圆扩大到纵向 3.4 米／横向 2.85 米，水雷外围爆炸扩大到 3.2 米／2.5 米，定时炸弹外围爆炸大幅扩大到 5.2 米／4.2 米。三者仍由房主计算受影响泳道掩码并通过既有可靠事件下发，未新增 wire 字段；同步放大现有池化水爆网格的变换，不增加节点、材质或逐帧几何。版本 67 及更旧版本不能混跑，避免范围参数不同。
