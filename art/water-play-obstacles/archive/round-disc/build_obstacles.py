...
def buoy(root,mat):
    # 直径 1.32m，主体厚 0.26m，与既有 0.67／0.65m 道具椭圆相符。
    body=Builder()
    body.lathe([(-.13,.48),(-.09,.6),(.02,.6),(.13,.5),(.14,.2)],CYAN,ellipse=.985)
    body.lathe([(-.07,.58),(-.035,.66),(.045,.66),(.105,.6),(.10,.55),(-.065,.55)],LIME,ellipse=.985)
    body.lathe([(.12,.18),(.19,.145),(.245,.125),(.25,.08),(.17,.08)],WHITE)
    body.lathe([(.16,.08),(.175,.08)],DARK)
    return [body.object('BuoyBody',mat,root)],{'sprayOrigin':[0,.25,0],'contacts':{'rimBodyOverlap':.05,'nozzleBodyOverlap':.02},'visibleRadii':[.66,.6501]}
