...
Project root: `F:\myworkspace\cocosProjects\SpeedSwimming`.
...
- Per-action sampled curves: `assets/scripts/character/sampled-actions/<action_id>.ts`
...
path = r'F:\myworkspace\cocosProjects\SpeedSwimming\tools\retarget-mixamo-swimming.py'
