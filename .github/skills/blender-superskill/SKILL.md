...
```powershell
python ".github/skills/blender-superskill/scripts/blender_orchestrator.py" --workspace "." run --task "<user task>" --reference "<reference image>"
```

For a staged or inspectable run:

```powershell
python ".github/skills/blender-superskill/scripts/blender_orchestrator.py" --workspace "." init --task "<user task>" --reference "<reference image>"
python ".github/skills/blender-superskill/scripts/blender_orchestrator.py" --workspace "." prompt latest
python ".github/skills/blender-superskill/scripts/blender_orchestrator.py" --workspace "." continue latest
```
