...
export const TUNING_GROUPS: TuningGroup[] = [
    ...
    },
    {
        ...
        controls: [
            ...
            control('water.underLightMin', '水下背光面亮度', '水下相机看到的角色背光面亮度倍率。', () => WATER_COLOR_TUNING.underLightMin, (v) => { WATER_COLOR_TUNING.underLightMin = v; applyWaterColorTuning(); }, 0.02, 0.3, 1.2, 2),
            ...
            control('water.surfaceLightMin', '水上背光面亮度', '水上相机看到水下角色时，背光面的亮度倍率。', () => WATER_COLOR_TUNING.surfaceLightMin, (v) => { WATER_COLOR_TUNING.surfaceLightMin = v; applyWaterColorTuning(); }, 0.02, 0.3, 1.2, 2),
            ...
            control('water.surfaceLightStart', '水面满光深度', '角色片元离水面小于这个深度时保留完整顶光；单位为米。', () => WATER_COLOR_TUNING.surfaceLightStart, (v) => { WATER_COLOR_TUNING.surfaceLightStart = v; applyWaterColorTuning(); }, 0.05, 0, 1.5, 2, 'm'),
            control('water.surfaceLightEnd', '水面光衰减终点', '角色片元达到这个水深时只保留深水环境光；调小会让明亮区域更贴近水面。', () => WATER_COLOR_TUNING.surfaceLightEnd, (v) => { WATER_COLOR_TUNING.surfaceLightEnd = v; applyWaterColorTuning(); }, 0.05, 0.1, 3, 2, 'm'),
            control('water.underDeepLight', '水下深处亮度', '水下相机看到深水角色时保留的环境光倍率；越低，离水面较远的身体越暗。', () => WATER_COLOR_TUNING.underDeepLight, (v) => { WATER_COLOR_TUNING.underDeepLight = v; applyWaterColorTuning(); }, 0.02, 0.05, 1, 2),
            control('water.surfaceDeepLight', '水上看深处亮度', '水上相机看到深水角色时保留的环境光倍率。', () => WATER_COLOR_TUNING.surfaceDeepLight, (v) => { WATER_COLOR_TUNING.surfaceDeepLight = v; applyWaterColorTuning(); }, 0.02, 0.05, 1, 2),
