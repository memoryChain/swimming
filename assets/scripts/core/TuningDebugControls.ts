...
export const TUNING_GROUPS: TuningGroup[] = [
    ...
    },
    {
        ...
        controls: [
            ...
            control('mineRelay.initialTransferCooldownSeconds', '初次接棒冷却', '观众席抛入炸弹到落在初始携带者身上的保护时间。', () => MINE_RELAY_TUNING.initialTransferCooldownSeconds, v => MINE_RELAY_TUNING.initialTransferCooldownSeconds = v, 0.05, 0.2, 1.5, 2, ' s'),
            ...
            control('mineRelay.assistedPassMaxAheadDistance', '辅助短传最大前距', '只允许把炸弹短传给前方该距离以内的选手。', () => MINE_RELAY_TUNING.assistedPassMaxAheadDistance, v => MINE_RELAY_TUNING.assistedPassMaxAheadDistance = v, 0.1, 1, 5, 1, ' m'),
            ...
            control('mineRelay.returnProtectionSeconds', '防回传时间', '上一持有者暂时不能接回炸弹的时间。', () => MINE_RELAY_TUNING.returnProtectionSeconds, v => MINE_RELAY_TUNING.returnProtectionSeconds = v, 0.05, 0.3, 3, 2, ' s'),
            ...
            control('mineRelay.starterNearbyAlongDistance', '初始可追纵向距离', '优先从纵向范围内确实存在可追目标的选手中发放炸弹。', () => MINE_RELAY_TUNING.starterNearbyAlongDistance, v => MINE_RELAY_TUNING.starterNearbyAlongDistance = v, 0.1, 1, 10, 1, ' m'),
