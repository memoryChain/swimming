...
export const TUNING_GROUPS: TuningGroup[] = [
    ...
    },
    {
        ...
        controls: [
            ...
            control('dolphin.ragdollCarryScale', '肢体错位继承', '海豚动作保留触发前四肢折叠与松动的比例；只影响表现，不改变碰撞与速度。', () => DOLPHIN_JUMP.ragdollCarryScale, (v) => DOLPHIN_JUMP.ragdollCarryScale = v, 0.05, 0, 1, 2),
            control('dolphin.ragdollAirWeight', '空中基础松动', '即使起跳前没有碰撞，海豚动作仍叠加的基础四肢松动强度。', () => DOLPHIN_JUMP.ragdollAirWeight, (v) => DOLPHIN_JUMP.ragdollAirWeight = v, 0.05, 0, 1, 2),
            control('dolphin.ragdollWindScale', '迎风摆动增幅', '飞行中段相对基础松动额外增加的摆动比例；起跳与入水边界会自动收敛。', () => DOLPHIN_JUMP.ragdollWindScale, (v) => DOLPHIN_JUMP.ragdollWindScale = v, 0.05, 0, 2, 2),
            control('dolphin.ragdollRecoverySeconds', '出水肢体恢复', '海豚动作结束并回到水面后，残余四肢错位恢复到普通游泳所用时间。', () => DOLPHIN_JUMP.ragdollRecoverySeconds, (v) => DOLPHIN_JUMP.ragdollRecoverySeconds = v, 0.05, 0.05, 3, 2, 's'),
