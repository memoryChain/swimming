...
export const TUNING_GROUPS: TuningGroup[] = [
    ...
    },
    {
        ...
        controls: [
            ...
            control('drafting.residueSeconds', '停止消散秒数', '停止前进后的残留上限，潜水和扶圈调整会直接切断。', () => DRAFTING_TUNING.residueSeconds, v => DRAFTING_TUNING.residueSeconds = v, 0.1, 0.1, 0.6, 1),
        ],
    },
    {
        name: '体力',
    ...
    },
    {
        ...
        controls: [
            ...
            control('stimulant.reactionDuration', '苏打发光时长', '拾取苏打道具后角色身体保持橙红脉冲发光的时间；再次拾取会刷新。', () => STIMULANT_BRAWL_TUNING.reactionDuration, v => STIMULANT_BRAWL_TUNING.reactionDuration = v, 0.5, 1, 12, 1, ' s'),
            ...
            control('stimulant.aiSkipHeartRate', 'AI 放弃争抢心率', 'AI 心率达到该值后不再主动追苏打，避免连续拾取导致转向过度。', () => STIMULANT_BRAWL_TUNING.aiSkipHeartRate, v => STIMULANT_BRAWL_TUNING.aiSkipHeartRate = v, 1, 100, 180, 0),
    ...
    },
    {
        name: '漩涡冲浪赛',
        controls: [
            control('whirlpool.inwardPullAcceleration', '向心吸力', '漩涡把泳者拉向中心的加速度。', () => WHIRLPOOL_BRAWL_TUNING.inwardPullAcceleration, v => WHIRLPOOL_BRAWL_TUNING.inwardPullAcceleration = v, 0.1, 0, 8, 1),
            control('whirlpool.coreCaptureAcceleration', '核心锁吸', '进入核心后额外增加的向心吸力；提高后更难从中心横向挣脱。', () => WHIRLPOOL_BRAWL_TUNING.coreCaptureAcceleration, v => WHIRLPOOL_BRAWL_TUNING.coreCaptureAcceleration = v, 0.1, 0, 8, 1),
            control('whirlpool.captureRadiusRatio', '内圈捕获范围', '从多大比例半径开始逐渐抵消自身推进，必须大于纯核心范围。', () => WHIRLPOOL_BRAWL_TUNING.captureRadiusRatio, v => WHIRLPOOL_BRAWL_TUNING.captureRadiusRatio = v, 0.02, 0.32, 0.9, 2),
            control('whirlpool.capturePropulsionDrag', '脱离阻力', '捕获区抵消玩家自身推进的速率；不影响水流本身的旋转推力。', () => WHIRLPOOL_BRAWL_TUNING.capturePropulsionDrag, v => WHIRLPOOL_BRAWL_TUNING.capturePropulsionDrag = v, 0.1, 0, 4, 1),
            control('whirlpool.approachForwardPullScale', '入场前吸比例', '靠近中心时向心力沿前进方向保留的比例，降低可避免直穿加速。', () => WHIRLPOOL_BRAWL_TUNING.approachForwardPullScale, v => WHIRLPOOL_BRAWL_TUNING.approachForwardPullScale = v, 0.05, 0, 1, 2),
            control('whirlpool.outerInwardScale', '外圈吸力比例', '外圈保留多少向心吸力；降低后更容易读出旋转推力，核心仍恢复完整吸力。', () => WHIRLPOOL_BRAWL_TUNING.outerInwardScale, v => WHIRLPOOL_BRAWL_TUNING.outerInwardScale = v, 0.05, 0, 1, 2),
            control('whirlpool.swirlAcceleration', '旋转推力', '切向水流造成的绕圈与甩尾强度。', () => WHIRLPOOL_BRAWL_TUNING.swirlAcceleration, v => WHIRLPOOL_BRAWL_TUNING.swirlAcceleration = v, 0.1, 0, 10, 1),
            control('whirlpool.coreSwirlScale', '核心旋转比例', '进入核心后保留多少旋转推力，避免核心绕转盖过吸入和回卷。', () => WHIRLPOOL_BRAWL_TUNING.coreSwirlScale, v => WHIRLPOOL_BRAWL_TUNING.coreSwirlScale = v, 0.05, 0, 1, 2),
            control('whirlpool.outerBoostAcceleration', '顺流外圈加速', '贴着旋转方向一致的外缘通过时获得的前进加速度。', () => WHIRLPOOL_BRAWL_TUNING.outerBoostAcceleration, v => WHIRLPOOL_BRAWL_TUNING.outerBoostAcceleration = v, 0.1, 0, 6, 1),
            control('whirlpool.outerCounterflowAcceleration', '逆流外圈阻力', '从逆着旋转方向的一侧通过时承受的额外反向加速度。', () => WHIRLPOOL_BRAWL_TUNING.outerCounterflowAcceleration, v => WHIRLPOOL_BRAWL_TUNING.outerCounterflowAcceleration = v, 0.1, 0, 6, 1),
            control('whirlpool.coreBackwardAcceleration', '中心回卷', '进入核心后受到的反向水流强度；与核心锁吸共同形成可操作逃脱的软捕获。', () => WHIRLPOOL_BRAWL_TUNING.coreBackwardAcceleration, v => WHIRLPOOL_BRAWL_TUNING.coreBackwardAcceleration = v, 0.1, 0, 10, 1),
            ...
            control('whirlpool.superCaptureRadiusScale', '超级捕获范围倍率', '超级漩涡内圈捕获范围相对普通版的倍率。', () => WHIRLPOOL_SUPER_TUNING.captureRadiusScale, v => WHIRLPOOL_SUPER_TUNING.captureRadiusScale = v, 0.05, 1, 1.5, 2),
            control('whirlpool.superCaptureDragScale', '超级脱离阻力倍率', '超级漩涡抵消玩家自身推进的倍率。', () => WHIRLPOOL_SUPER_TUNING.captureDragScale, v => WHIRLPOOL_SUPER_TUNING.captureDragScale = v, 0.05, 1, 2, 2),
    ...
    },
    {
        name: '娱乐玩法浮圈恢复',
        controls: [
            control('recovery.knockedSeconds', '调整等待时间', '娱乐命中后扶圈调整到重新开游的时间，浮圈演出不延长计时。', () => ENTERTAINMENT_RECOVERY_TUNING.knockedSeconds, v => ENTERTAINMENT_RECOVERY_TUNING.knockedSeconds = v, 0.1, 0.5, 4, 1, ' s'),
            control('recovery.invulnerableSeconds', '重生无敌时间', '重新入水后不会再次被玩具鲨、水球核心或定时水球击倒的时间。', () => ENTERTAINMENT_RECOVERY_TUNING.invulnerableSeconds, v => ENTERTAINMENT_RECOVERY_TUNING.invulnerableSeconds = v, 0.1, 0.5, 5, 1, ' s'),
            ...
            control('recovery.disappearBlinkSeconds', '旧位置闪退时间', '扶圈调整结束前在原位置闪烁三次并完全隐藏的时间。', () => ENTERTAINMENT_RECOVERY_TUNING.disappearBlinkSeconds, v => ENTERTAINMENT_RECOVERY_TUNING.disappearBlinkSeconds = v, 0.05, 0, 1.2, 2, ' s'),
            ...
            control('recovery.floatSurfaceY', '浮圈托举高度', '圈心相对泳者水面根节点的高度；双臂与圈一起移动。', () => CHARACTER_POSE_TUNING.recoveryFloatSurfaceY, v => CHARACTER_POSE_TUNING.recoveryFloatSurfaceY = v, 0.01, 0.04, 0.18, 2, ' m'),
            control('recovery.floatSizeScale', '浮圈大小', '以原肩宽适配圈径为基准，双臂同步张开以贴合放大后的圈沿。', () => CHARACTER_POSE_TUNING.recoveryFloatSizeScale, v => CHARACTER_POSE_TUNING.recoveryFloatSizeScale = v, 0.02, 1, 1.2, 2, ' 倍'),
            control('recovery.floatHandStaggerSeconds', '双手搭圈错开', '一只手先扶住，另一只随后跟上；总搭圈时间保持不变。', () => CHARACTER_POSE_TUNING.recoveryFloatHandStaggerSeconds, v => CHARACTER_POSE_TUNING.recoveryFloatHandStaggerSeconds = v, 0.02, 0, 0.16, 2, ' s'),
            control('recovery.floatEnterSeconds', '搭圈混合时间', '双手前伸后压住圈沿的时间，晚到状态直接恢复当前姿态。', () => CHARACTER_POSE_TUNING.recoveryFloatEnterSeconds, v => CHARACTER_POSE_TUNING.recoveryFloatEnterSeconds = v, 0.02, 0.2, 0.7, 2, ' s'),
            control('recovery.floatImpactSeconds', '受击失衡时间', '从命中前姿态过渡到侧翻失衡，不增加暂停时长。', () => CHARACTER_POSE_TUNING.recoveryFloatImpactSeconds, v => CHARACTER_POSE_TUNING.recoveryFloatImpactSeconds = v, 0.02, 0.14, 0.36, 2, ' s'),
            control('recovery.floatRingDelaySeconds', '浮圈出现时机', '失衡后开始找圈的时间；空中受击会等接近落水再出现。', () => CHARACTER_POSE_TUNING.recoveryFloatRingDelaySeconds, v => CHARACTER_POSE_TUNING.recoveryFloatRingDelaySeconds = v, 0.02, 0.24, 0.5, 2, ' s'),
            control('recovery.floatReachSeconds', '伸手找圈时间', '身体回正、双臂向圈沿靠近的时长。', () => CHARACTER_POSE_TUNING.recoveryFloatReachSeconds, v => CHARACTER_POSE_TUNING.recoveryFloatReachSeconds = v, 0.02, 0.2, 0.5, 2, ' s'),
            control('recovery.floatBodyTiltDegrees', '扶圈身体前倾', '胸前靠圈时身体相对直立的前倾角。', () => CHARACTER_POSE_TUNING.recoveryFloatBodyTiltDegrees, v => CHARACTER_POSE_TUNING.recoveryFloatBodyTiltDegrees = v, 1, 25, 45, 0, '°'),
            control('recovery.floatSwayDegrees', '扶圈侧摆', '身体和圈共用的小幅侧摆。', () => CHARACTER_POSE_TUNING.recoveryFloatSwayDegrees, v => CHARACTER_POSE_TUNING.recoveryFloatSwayDegrees = v, 0.5, 0, 4, 1, '°'),
            control('recovery.floatBobAmplitude', '扶圈起伏', '稳定托浮时的轻微上下起伏，不改变赛程。', () => CHARACTER_POSE_TUNING.recoveryFloatBobAmplitude, v => CHARACTER_POSE_TUNING.recoveryFloatBobAmplitude = v, 0.002, 0, 0.024, 3, ' m'),
        ],
    },
    {
        name: '定时水球模式',
        controls: [
            control('mineRelay.transferBodyAlongRadius', '身体前后传递半径', '每名选手沿赛道方向参与贴身传递的身体半径；实际传递范围为双方半径之和。', () => MINE_RELAY_TUNING.transferBodyAlongRadius, v => MINE_RELAY_TUNING.transferBodyAlongRadius = v, 0.025, 0.25, 1.25, 3, ' m'),
            control('mineRelay.transferBodyLateralRadius', '身体横向传递半径', '每名选手跨泳道方向参与贴身传递的身体半径；实际传递范围为双方半径之和。', () => MINE_RELAY_TUNING.transferBodyLateralRadius, v => MINE_RELAY_TUNING.transferBodyLateralRadius = v, 0.025, 0.2, 1, 3, ' m'),
            ...
            control('mineRelay.initialTransferCooldownSeconds', '初次接棒冷却', '观众席抛入水球到落在初始携带者身上的保护时间。', () => MINE_RELAY_TUNING.initialTransferCooldownSeconds, v => MINE_RELAY_TUNING.initialTransferCooldownSeconds = v, 0.05, 0.2, 1.5, 2, ' s'),
            control('mineRelay.transferCooldownSeconds', '传递冷却', '完成传递后暂时不能再次传递的时间。', () => MINE_RELAY_TUNING.transferCooldownSeconds, v => MINE_RELAY_TUNING.transferCooldownSeconds = v, 0.05, 0.2, 2, 2, ' s'),
            control('mineRelay.assistedPassMinAheadDistance', '辅助短传最小前距', '目标至少领先该距离才会进入定向短传候选，避免替代原有贴身碰撞传递。', () => MINE_RELAY_TUNING.assistedPassMinAheadDistance, v => MINE_RELAY_TUNING.assistedPassMinAheadDistance = v, 0.05, 0, 1.5, 2, ' m'),
            control('mineRelay.assistedPassMaxAheadDistance', '辅助短传最大前距', '只允许把水球短传给前方该距离以内的选手。', () => MINE_RELAY_TUNING.assistedPassMaxAheadDistance, v => MINE_RELAY_TUNING.assistedPassMaxAheadDistance = v, 0.1, 1, 5, 1, ' m'),
            control('mineRelay.assistedPassLateralDistance', '辅助短传横向距离', '候选人与携带者横向对齐所允许的最大间距。', () => MINE_RELAY_TUNING.assistedPassLateralDistance, v => MINE_RELAY_TUNING.assistedPassLateralDistance = v, 0.05, 0.4, 2.5, 2, ' m'),
            control('mineRelay.assistedPassConfirmSeconds', '辅助短传确认时间', '同一候选人持续满足方向和距离条件后才完成短传，过滤擦边与瞬时网络校正。', () => MINE_RELAY_TUNING.assistedPassConfirmSeconds, v => MINE_RELAY_TUNING.assistedPassConfirmSeconds = v, 0.01, 0.05, 0.5, 2, ' s'),
            control('mineRelay.returnProtectionSeconds', '防回传时间', '上一持有者暂时不能接回水球的时间。', () => MINE_RELAY_TUNING.returnProtectionSeconds, v => MINE_RELAY_TUNING.returnProtectionSeconds = v, 0.05, 0.3, 3, 2, ' s'),
            control('mineRelay.lockSeconds', '最后锁定时间', '倒计时归零前禁止继续传递的时长。', () => MINE_RELAY_TUNING.lockSeconds, v => MINE_RELAY_TUNING.lockSeconds = v, 0.05, 0.2, 2, 2, ' s'),
            control('mineRelay.recoverySeconds', '轮间休息', '一轮喷水或带球冲线后到下一轮可启动的间隔。', () => MINE_RELAY_TUNING.recoverySeconds, v => MINE_RELAY_TUNING.recoverySeconds = v, 0.1, 0, 5, 1, ' s'),
            control('mineRelay.starterNearbyAlongDistance', '初始可追纵向距离', '优先从纵向范围内确实存在可追目标的选手中发放水球。', () => MINE_RELAY_TUNING.starterNearbyAlongDistance, v => MINE_RELAY_TUNING.starterNearbyAlongDistance = v, 0.1, 1, 10, 1, ' m'),
            control('mineRelay.starterNearbyLateralDistance', '初始可追横向距离', '初始携带者与可追目标允许的最大横向间距。', () => MINE_RELAY_TUNING.starterNearbyLateralDistance, v => MINE_RELAY_TUNING.starterNearbyLateralDistance = v, 0.1, 1, 10, 1, ' m'),
            control('mineRelay.explosionBackwardImpulse', '喷水后退冲量', '水球喷水对携带者施加的反向冲量。', () => MINE_RELAY_TUNING.explosionBackwardImpulse, v => MINE_RELAY_TUNING.explosionBackwardImpulse = v, 0.05, 0, 5, 2),
            control('mineRelay.explosionLateralImpulse', '喷水横移冲量', '水球喷水把携带者推向泳池外侧的冲量。', () => MINE_RELAY_TUNING.explosionLateralImpulse, v => MINE_RELAY_TUNING.explosionLateralImpulse = v, 0.05, 0, 6, 2),
            control('mineRelay.explosionAxialImpulse', '喷水翻滚冲量', '水球喷水造成的轴向翻滚强度。', () => MINE_RELAY_TUNING.explosionAxialImpulse, v => MINE_RELAY_TUNING.explosionAxialImpulse = v, 0.1, 0, 10, 1),
            control('mineRelay.explosionPitchImpulse', '喷水俯仰冲量', '水球喷水造成的头端下扎强度。', () => MINE_RELAY_TUNING.explosionPitchImpulse, v => MINE_RELAY_TUNING.explosionPitchImpulse = v, 0.05, 0, 8, 2),
            control('mineRelay.explosionSoftnessLateralImpulse', '喷水侧向软体', '喷水叠加到四肢和躯干的侧向柔性冲量。', () => MINE_RELAY_TUNING.explosionSoftnessLateralImpulse, v => MINE_RELAY_TUNING.explosionSoftnessLateralImpulse = v, 0.05, 0, 4, 2),
            control('mineRelay.explosionSoftnessForwardImpulse', '喷水前后软体', '喷水叠加到四肢和躯干的前后柔性冲量，可为负。', () => MINE_RELAY_TUNING.explosionSoftnessForwardImpulse, v => MINE_RELAY_TUNING.explosionSoftnessForwardImpulse = v, 0.05, -3, 3, 2),
        ],
    },
    {
        name: '喷水浮标',
        controls: [
            ...
            control('minefield.waveThirdDistance', '第三波触发距离', '单独浮标玩法中，领先选手达到该赛程距离时再次补齐已消失的浮标。', () => MINEFIELD_TUNING.waveThirdDistance, v => MINEFIELD_TUNING.waveThirdDistance = v, 1, 100, 180, 0, ' m'),
            control('minefield.mineItemAlongRadius', '浮标前后接触半径', '浮标自身沿赛道方向的接触半径，结算时与人物身体半径相加。', () => MINEFIELD_TUNING.mineItemAlongRadius, v => MINEFIELD_TUNING.mineItemAlongRadius = v, 0.025, 0.2, 1.5, 3, ' m'),
            control('minefield.mineItemLateralRadius', '浮标横向接触半径', '浮标自身跨泳道方向的接触半径，结算时与人物身体半径相加。', () => MINEFIELD_TUNING.mineItemLateralRadius, v => MINEFIELD_TUNING.mineItemLateralRadius = v, 0.025, 0.2, 1.5, 3, ' m'),
            control('minefield.swimmerContactAlongRadius', '身体前后触碰半径', '人物身体沿赛道方向参与浮标实体触碰的简化半径。', () => MINEFIELD_TUNING.swimmerContactAlongRadius, v => MINEFIELD_TUNING.swimmerContactAlongRadius = v, 0.02, 0.3, 1.2, 2, ' m'),
            control('minefield.swimmerContactLateralRadius', '身体横向触碰半径', '人物身体跨泳道方向参与浮标实体触碰的简化半径。', () => MINEFIELD_TUNING.swimmerContactLateralRadius, v => MINEFIELD_TUNING.swimmerContactLateralRadius = v, 0.02, 0.2, 0.8, 2, ' m'),
            control('minefield.driftAlongRadius', '前后漂移半径', '浮标围绕锚点沿赛道方向漂动的最大距离。', () => MINEFIELD_TUNING.driftAlongRadius, v => MINEFIELD_TUNING.driftAlongRadius = v, 0.05, 0, 2, 2, ' m'),
            control('minefield.driftLateralRadius', '横向漂移半径', '浮标围绕锚点跨泳道漂动的最大距离。', () => MINEFIELD_TUNING.driftLateralRadius, v => MINEFIELD_TUNING.driftLateralRadius = v, 0.05, 0, 2, 2, ' m'),
            control('minefield.driftSpeed', '漂移速度', '所有浮标围绕锚点漂动的基础速度。', () => MINEFIELD_TUNING.driftSpeed, v => MINEFIELD_TUNING.driftSpeed = v, 0.05, 0.1, 2, 2),
            control('minefield.spawnClearAlongRadius', '出生前后安全区', '动态投放时，选手位于该前后半径内则浮标保持隐藏且不启用。', () => MINEFIELD_TUNING.spawnClearAlongRadius, v => MINEFIELD_TUNING.spawnClearAlongRadius = v, 0.05, 1.35, 5, 2, ' m'),
            control('minefield.spawnClearLateralRadius', '出生横向安全区', '动态投放时，选手位于该横向半径内则浮标保持隐藏且不启用。', () => MINEFIELD_TUNING.spawnClearLateralRadius, v => MINEFIELD_TUNING.spawnClearLateralRadius = v, 0.05, 1.05, 4, 2, ' m'),
            control('minefield.spawnClearSeconds', '离开后启用延迟', '所有选手离开出生安全区后，浮标还需连续保持安全的时间。', () => MINEFIELD_TUNING.spawnClearSeconds, v => MINEFIELD_TUNING.spawnClearSeconds = v, 0.05, 0, 2, 2, ' s'),
            control('minefield.aiLookAhead', 'AI 预判距离', 'AI 在多远处开始考虑绕开同横向区域的浮标。', () => MINEFIELD_TUNING.aiLookAhead, v => MINEFIELD_TUNING.aiLookAhead = v, 0.25, 2, 10, 2, ' m'),
            control('minefield.aiAvoidOffset', 'AI 避让偏移', 'AI 绕行时相对浮标横向中心的目标偏移。', () => MINEFIELD_TUNING.aiAvoidOffset, v => MINEFIELD_TUNING.aiAvoidOffset = v, 0.05, 0.5, 4, 2, ' m'),
        ],
    },
    {
        name: '杂物漂流大乱斗',
        controls: [
            control('litter.fallingSeconds', '杂物飞行时间', '从看台方向高处抛入到权威落点的时长，越长留给玩家的预警越充足。', () => LITTER_BRAWL_TUNING.fallingSeconds, v => LITTER_BRAWL_TUNING.fallingSeconds = v, 0.05, 0.6, 3, 2, ' s'),
            control('litter.burstGroupIntervalSeconds', '分批投放间隔', '每波六件杂物按两件一组投放，相邻两组之间的时间间隔。', () => LITTER_BRAWL_TUNING.burstGroupIntervalSeconds, v => LITTER_BRAWL_TUNING.burstGroupIntervalSeconds = v, 0.02, 0.16, 0.7, 2, ' s'),
            control('litter.contactAlongRadius', '前后减速范围', '杂物沿赛道方向的柔性接触半径。', () => LITTER_BRAWL_TUNING.contactAlongRadius, v => LITTER_BRAWL_TUNING.contactAlongRadius = v, 0.05, 0.5, 3, 2, ' m'),
            control('litter.contactLateralRadius', '横向减速范围', '杂物跨泳道方向的柔性接触半径。', () => LITTER_BRAWL_TUNING.contactLateralRadius, v => LITTER_BRAWL_TUNING.contactLateralRadius = v, 0.05, 0.4, 2.5, 2, ' m'),
            control('litter.maxEnvironmentDrag', '中心最大阻力', '从杂物中心穿过时叠加到前进速度的最大水阻系数；不影响方向。', () => LITTER_BRAWL_TUNING.maxEnvironmentDrag, v => LITTER_BRAWL_TUNING.maxEnvironmentDrag = v, 0.05, 0, 1.5, 2),
            control('litter.swimmerContactAlongRadius', '身体前后接触半径', '人物身体沿赛道方向参与杂物实体接触的简化半径；不会扩大软杂物的持续减速区。', () => LITTER_BRAWL_TUNING.swimmerContactAlongRadius, v => LITTER_BRAWL_TUNING.swimmerContactAlongRadius = v, 0.02, 0.3, 1.2, 2, ' m'),
            control('litter.swimmerContactLateralRadius', '身体横向接触半径', '人物身体跨泳道方向参与杂物实体接触的简化半径。', () => LITTER_BRAWL_TUNING.swimmerContactLateralRadius, v => LITTER_BRAWL_TUNING.swimmerContactLateralRadius = v, 0.02, 0.2, 0.8, 2, ' m'),
            ...
            control('litter.rigidSpeedRetain', '硬碰后速度保留', '撞上硬杂物后立即保留的当前前进速度比例；越低瞬时掉速越明显。', () => LITTER_BRAWL_TUNING.rigidSpeedRetain, v => LITTER_BRAWL_TUNING.rigidSpeedRetain = v, 0.05, 0.2, 1, 2),
            control('litter.rigidBackwardImpulse', '硬碰后退冲量', '硬杂物碰撞给选手的短促后退冲量，不触发击倒。', () => LITTER_BRAWL_TUNING.rigidBackwardImpulse, v => LITTER_BRAWL_TUNING.rigidBackwardImpulse = v, 0.05, 0, 2, 2),
            control('litter.rigidLateralImpulse', '硬碰侧弹冲量', '硬杂物碰撞把选手向接触点外侧弹开的冲量。', () => LITTER_BRAWL_TUNING.rigidLateralImpulse, v => LITTER_BRAWL_TUNING.rigidLateralImpulse = v, 0.05, 0, 3, 2),
            ...
            control('litter.driftAlongRadius', '杂物前后漂动幅度', '水流漂移沿赛道方向的最大活动范围。', () => LITTER_BRAWL_TUNING.driftAlongRadius, v => LITTER_BRAWL_TUNING.driftAlongRadius = v, 0.05, 0.1, 0.8, 2, ' m'),
            control('litter.driftLateralRadius', '杂物横向漂动幅度', '水流漂移跨泳道方向的最大活动范围。', () => LITTER_BRAWL_TUNING.driftLateralRadius, v => LITTER_BRAWL_TUNING.driftLateralRadius = v, 0.05, 0.1, 0.7, 2, ' m'),
            control('litter.driftSpeed', '杂物漂动速度', '两组缓慢水流摆动的基础速度。', () => LITTER_BRAWL_TUNING.driftSpeed, v => LITTER_BRAWL_TUNING.driftSpeed = v, 0.02, 0.1, 1, 2),
            control('litter.driftEntryBlendSeconds', '落水漂动渐入', '杂物落水后从真实落点逐渐过渡到自然漂动的时长，避免入水瞬间横跳。', () => LITTER_BRAWL_TUNING.driftEntryBlendSeconds, v => LITTER_BRAWL_TUNING.driftEntryBlendSeconds = v, 0.05, 0.2, 2, 2, ' s'),
            control('litter.floatingLifetime', '正常漂浮时长', '杂物落水后保持可碰撞状态的时间，结束后在原地附近开始下沉。', () => LITTER_BRAWL_TUNING.floatingLifetime, v => LITTER_BRAWL_TUNING.floatingLifetime = v, 0.5, 6, 24, 1, ' s'),
