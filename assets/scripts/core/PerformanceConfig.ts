...
export const PERFORMANCE_CONFIG = {
    characterOutline: {
        // 主角始终保留描边；对手按主相机到角色根节点的世界距离（米）判断。
        // 两个阈值之间保持当前状态，避免临界距离来回闪烁。
        opponentEnableDistance: 14,
        opponentDisableDistance: 17,
        refreshSeconds: 0.1,
    },
    ...
    water: {
        ...
        roofLightReflectionEnabled: true,
        roofLightReflectionStrength: 0.26,
    },
