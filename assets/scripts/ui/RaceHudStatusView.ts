...
export class RaceHudStatusView {
    ...
    constructor(parent: Node, onJump: () => void) {
        ...
        this.heartValue = this.label(readouts, 'HeartValue', '0', 30, 152, 60, 25, 18.4);
        ...
        this.sprite(readouts, 'EnergyTrack', 'ring', 122, 114, 76, 76, TRACK);
        this.energyRing = this.ring(readouts, 'EnergyFill', 122, 114, 76, CYAN);
        this.sprite(readouts, 'Lightning', 'lightning', 151, 126, 21, 28, CYAN);
