...
export function openSettingsPanel(canvasNode: Node, designWidth: number, designHeight: number): void {
    ...
    buildVolumeRow(panel, '音乐', SettingsManager.musicVolume, 40, (v) => SettingsManager.setMusicVolume(v));
    buildVolumeRow(panel, '音效', SettingsManager.sfxVolume, -46, (v) => SettingsManager.setSfxVolume(v));
}
